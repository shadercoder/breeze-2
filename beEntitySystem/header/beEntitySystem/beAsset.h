...
BE_ENTITYSYSTEM_API void LoadAsset(EntityGroup &group, const rapidxml::xml_node<lean::utf8_t> &parentNode, beCore::ParameterSet &parameters);

/// Loads entities and resources from the given xml node.
BE_ENTITYSYSTEM_API void LoadAsset(EntityGroup &group, const utf8_ntri &file, beCore::ParameterSet &parameters);
