...
class ShapeCompoundPX : public lean::noncopyable, public ShapeCompound
{
public:
...
public:
	/// Constructor.
	BE_PHYSICS_PX_API ShapeCompoundPX();
	/// Destructor.
	BE_PHYSICS_PX_API ~ShapeCompoundPX();
...
template <> struct ToImplementationPX<ShapeCompound> { typedef ShapeCompoundPX Type; };
