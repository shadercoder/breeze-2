...
public:
	...
	/// Sets the angles.
	LEAN_INLINE void SetInnerAngle(float innerAngle) { m_innerAngle = innerAngle; m_bConstantsChanged = true; }
	/// Sets the angles.
	LEAN_INLINE void SetOuterAngle(float outerAngle) { m_outerAngle = outerAngle; m_bConstantsChanged = true; }
