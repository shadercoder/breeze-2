...
{
	static const beCore::ReflectionProperties value;
};

template <class Material>
const beCore::ReflectionProperties MeshProperties<Material>::value = beCore::ReflectionProperties::construct_inplace()
