...
public:
	...
	/// Sets the given (raw) values.
	BE_GRAPHICS_DX11_API bool SetPropertyRaw(uint4 id, const void *values, size_t bytes);
	/// Gets the given number of (raw) values.
	BE_GRAPHICS_DX11_API bool GetPropertyRaw(uint4 id, void *values, size_t bytes) const;
